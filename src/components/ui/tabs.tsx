...
>(({ className, ...props }, ref) => (
   <TabsPrimitive.Trigger
      ref={ref}
      className={cn(
         'inline-flex cursor-default items-center justify-center whitespace-nowrap rounded-lg px-3 py-1.5 font-sf-pro-display text-base font-medium ring-offset-white-250 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-black-500 data-[state=active]:text-white-100 data-[state=inactive]:text-black-500 data-[state=active]:shadow-sm dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300 dark:data-[state=active]:bg-slate-950 dark:data-[state=active]:text-slate-50',
         className
      )}
      {...props}
   />
